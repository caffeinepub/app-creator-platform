...
import {
  AUDIO_PRESETS,
  type AudioTuningParams,
  DEFAULT_PARAMS,
} from "../data/audioPresets";
...
export default function AudioTuningPanel({
  params,
  onChange,
}: AudioTuningPanelProps) {
  const set = useCallback(
    <K extends keyof AudioTuningParams>(
      key: K,
      value: AudioTuningParams[K],
    ) => {
