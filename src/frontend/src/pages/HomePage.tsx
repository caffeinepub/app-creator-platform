...
const features = [
  ...
  },
  {
    ...
    desc: "Create stunning 3D scenes, WebGL animations, and immersive visual experiences.",
  },
  {
    icon: <Zap className="w-5 h-5" />,
    title: "Any Project Type",
    desc: "Landing pages, dashboards, games, 3D scenes, videos — build anything.",
  },
  {
    icon: <Film className="w-5 h-5" />,
    title: "Video & Motion",
    desc: "Generate animated sequences, motion graphics, and cinematic canvas effects.",
  },
  {
...
const projectTypes = [
  ...
  { icon: <Box className="w-5 h-5" />, label: "3D Scenes" },
  { icon: <Film className="w-5 h-5" />, label: "Animations" },
...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
        ...
        <section className="relative overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto px-6 pt-24 pb-20 text-center relative">
            ...
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-brand/30 bg-brand/10 text-brand text-xs font-medium mb-8">
              ...
              AI-Powered App Builder · 3D · Animation · Video
            </div>
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto mb-10 leading-relaxed">
              Noventra.ai generates complete applications, 3D animations, motion
              graphics, interactive games, and more — all from a single
              description.
            </p>
        ...
        <section className="max-w-6xl mx-auto px-6 py-20">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground max-w-xl mx-auto">
              From 2D apps to immersive 3D experiences — Noventra.ai handles it
              all.
            </p>
          </div>
        ...
        <section className="max-w-4xl mx-auto px-6 py-16 text-center">
          <div className="glass-card rounded-3xl p-12 border border-brand/20 relative overflow-hidden">
            ...
            <p className="text-muted-foreground mb-8 relative">
              Apps, 3D scenes, animations, games — all from natural language.
            </p>
            <button
              type="button"
              onClick={handleCTA}
      ...
      {/* Footer — Noventra branding only */}
      <footer className="border-t border-white/5 py-8">
        <div className="max-w-6xl mx-auto px-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          <Logo size="small" />
          <p className="text-xs text-muted-foreground">
            © {new Date().getFullYear()} Noventra.Ai — Elite AI App Builder
          </p>
        </div>
      </footer>
    </div>
