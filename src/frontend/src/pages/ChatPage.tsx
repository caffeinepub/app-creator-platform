...
export default function ChatPage() {
  ...
  const sendMessage = useCallback(
    async (messageText: string) => {
      ...
      try {
        ...
        setApiError({
          message:
            llmErr?.message || "Could not reach the AI service. Please retry.",
  ...
  if (sessionError) {
    ...
    const isNotFound =
      errMsg.includes("not found") || errMsg.includes("Access denied");
    return (
              ...
              {codeContent ? (
                ...
                <div className="flex flex-col items-center justify-center h-full text-center p-8">
                  ...
                  <p className="text-sm text-muted-foreground/40 max-w-xs leading-relaxed">
                    Send a message to generate your application and see the code
                    here.
                  </p>
                </div>
              )}
